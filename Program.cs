...
app.MapPost("/api/evaluate", async (Dictionary<int, int> answers) =>
{
    ...
    - Fields should not be too specialized or obscure. Be accessible and realistic for a high school student to understand eg: Civil Engineer, Chaos Engineer, Aerospace Engineer, Environmental Engineer, Mechatronics Engineer, Surgeon, Clinical Neuropsychologist, Epidemiologist, Biomedical Engineer, Genetic Counselor, Data Scientist, Financial Quantitative Analyst, Information Security Analyst, Full-Stack Software Developer, Actuary, Intellectual Property Attorney, Management Consultant, Industrial-Organizational Psychologist, Corporate Compliance Officer, Supply Chain Logistics Manager, Anthropologist, Archivist, Historian, Linguist, Public Policy Analyst, Technical Writer, Urban Planner, Investigative Journalist, Foreign Service Officer, Museum Curator, Special Education Teacher, High School STEM Teacher, ESL Instructor, Early Childhood Educator, Reading Intervention Specialist, Montessori Guide, Gifted and Talented Coordinator, Career and Technical Education Teacher, Adult Literacy Instructor, Instructional Coach
    - If possible, try to mix both social and technical career paths, and both creative and analytical ones, to give them a diverse range of options that could suit different facets of their profile.
    - Don't be biased towards the examples I gave. Use them as a loose guide but feel free to suggest other careers that might be an even better fit for their unique profile.
